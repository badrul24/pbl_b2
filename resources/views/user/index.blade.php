...
@section('content')
    ...
    <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between mb-6">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500">Kelola Data Pengguna</p>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-sm p-6 mb-6">
        <form action="{{ route('user.index') }}" method="GET" class="flex flex-col md:flex-row gap-4">
            <div class="flex-1">
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-100">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Email Verifikasi</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @foreach ($users as $user)
                        <tr class="hover:bg-gray-50 transition duration-200">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                {{ $user->email_verified_at ? $user->email_verified_at->format('d-m-Y H:i') : 'Belum Verifikasi' }}
                            </td>
