...
@section('content')
    ...
    <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between mb-6">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500">Kelola Data Berita</p>
        </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @foreach ($beritas as $berita)
                        <tr class="hover:bg-gray-50 transition duration-200">
                            ...
                            <td class="px-6 py-4 text-sm text-gray-500">
                                <img src="{{ asset($berita->gambar) }}" alt="{{ $berita->judul_berita }}"
                            ...
                            <td class="px-6 py-4 text-sm font-medium space-x-2">
                                {{-- <a href="{{ route('berita.show', $berita->id) }}"
                                    class="inline-flex items-center px-3 py-1.5 bg-primary-500 hover:bg-primary-600 text-white rounded-lg transition duration-200">
                                ...
                                <form action="{{ route('berita.destroy', $berita->id) }}" method="POST" class="inline delete-form">
                                    @csrf
                                    @method('DELETE')
                                    <button type="button"
                                        class="delete-btn inline-flex items-center px-3 py-1.5 bg-red-500 hover:bg-red-600 text-white rounded-lg transition duration-200">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1.5" fill="none"
                                            viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
