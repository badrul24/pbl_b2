...
@section('title', 'Kode Arsip')

@section('content')
    <!-- Page Header -->
    <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between mb-6">
        <div>
            <h2 class="text-2xl font-bold text-gray-900">Kode Arsip</h2>
            <p class="mt-1 text-sm text-gray-500">Kelola Data Kode</p>
        </div>
        <a href="{{ route('kode.create') }}"
    ...
    <div class="bg-white rounded-xl shadow-sm p-6 mb-6">
        <form action="{{ route('kode.index') }}" method="GET" class="flex flex-col md:flex-row gap-4">
            <div class="flex-1">
                    ...
                    @foreach ($kodes as $kode)
                        <tr class="hover:bg-gray-50 transition duration-200">
                            ...
                            <td class="px-6 py-4 text-sm text-gray-500 max-w-xs">
                                <div class="whitespace-normal break-words">{{ $kode->keterangan }}</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                <a href="{{ route('kode.edit', $kode->id) }}"
                                ...
                                <form action="{{ route('kode.destroy', $kode->id) }}" method="POST"
