...
@section('content')
    ...
    <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between mb-6">
        <div>
            <h2 class="text-2xl font-bold text-gray-900">Lokasi Arsip</h2>
            <p class="mt-1 text-sm text-gray-500">Kelola Data Lokasi</p>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-sm p-6 mb-6">
        <form action="{{ route('lokasi.index') }}" method="GET" class="flex flex-col md:flex-row gap-4">
            <div class="flex-1">
                    ...
                    @foreach ($lokasis as $lokasi)
                        <tr class="hover:bg-gray-50 transition duration-200">
                            ...
                            <td class="px-6 py-4 text-sm text-gray-500 max-w-xs">
                                <div class="whitespace-normal break-words">{{ $lokasi->keterangan }}</div>
                            </td>
